...
public class OldPerformancesBatch {
    ...
    public OldPerformancesBatch(JobRepository jobRepository, PlatformTransactionManager platformTransactionManager, @Qualifier("dataDBSource") DataSource dataDBSource) {
